...
export default function RegisterStartupScreen({ route, navigation }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.problemStatement.trim()) newErrors.problemStatement = 'Problem is required';
    ...
    >
      ...
      >
        <Text style={styles.headerTitle}>
          {editMode ? 'Edit Startup' : 'Register Startup'}
        </Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        {/* BASIC INFO */}
        <FormSection title="Basic Information" icon="business-outline" dark>
          <FormInput
            label="Startup Name"
            value={formData.name}
        ...
        {/* PROBLEM & SOLUTION */}
        <FormSection title="Problem & Solution" icon="bulb-outline" dark>
          <FormInput
            label="Problem"
            value={formData.problemStatement}
          ...
          <FormInput
            label="Target Market"
            value={formData.targetMarket}
            onChangeText={(v) => updateFormData('targetMarket', v)}
          />
        </FormSection>

        {/* METRICS */}
        <FormSection title="Business Metrics" icon="analytics-outline" dark>
          <FormInput
        ...
        {/* DOCUMENTS */}
        <FormSection title="Documents" icon="folder-outline" dark>
          <FileUpload
            label="Upload Files"
            files={formData.documents}
            onFileSelect={(files) => updateFormData('documents', files)}
        ...
        <FormActions
          ...
          saveText={editMode ? 'Update Startup' : 'Register Startup'}
        />
      </ScrollView>
    </KeyboardAvoidingView>
  );
